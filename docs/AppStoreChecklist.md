...
This repo can build a local Stash macOS app bundle, but App Store submission
...
- Privacy manifest: `Sources/Hatch/Resources/PrivacyInfo.xcprivacy`
- App icon: `Sources/Hatch/Resources/Hatch.icns`
...
- App Store Connect app record for bundle ID `com.ivynbean.Stash`.
...
```bash
codesign -dvvv --entitlements :- dist/Stash.app
spctl -a -vv dist/Stash.app
plutil -p dist/Stash.app/Contents/Info.plist
```
